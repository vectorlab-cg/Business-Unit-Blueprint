...
(function (global) {
  ...
  function genera(bu) {
    ...
    righe.push('');
    righe.push('## Profilo');
    righe.push(render.testoCampo(bu, 'mercato', 'cliente_ideale'));
    righe.push('');
    righe.push('## Chi decide');
    righe.push('- Ruolo: ' + render.testoCampo(bu, 'mercato', 'decisore'));
    righe.push('- Cosa ha sul tavolo quando arrivate: ' + render.testoCampo(bu, 'mercato', 'contesto_decisore'));
    righe.push('');
    ...
    righe.push(render.testoCampo(bu, 'mercato', 'alternativa_attuale'));
    righe.push('');
